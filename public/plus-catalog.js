...
export const PLUS_COMBOS = [
 ...
 {id:'neon-city',name:'Cidade neon',color:'#73dfff',items:['neon','rain','terminal']},
 {id:'solar',name:'Chama solar',color:'#ffb176',items:['fire','embers','sunset']},
 {id:'winter',name:'Inverno',color:'#a8eeff',items:['frost','snow','ice']},
 {id:'spring',name:'Primavera',color:'#ffa9d2',items:['petals','candy']},
 {id:'royal',name:'Realeza astral',color:'#d7b5ff',items:['royal','aurora']},
 {id:'prism',name:'Prisma',color:'#b4e6ff',items:['prism']},
 {id:'lunar',name:'Lua cheia',color:'#ccd4ff',items:['lunar']},
 {id:'love',name:'Do coração',color:'#ffb6d0',items:['hearts','bubbles']},
 {id:'glitch',name:'Glitch',color:'#b3ffbd',items:['glitch']}
];
